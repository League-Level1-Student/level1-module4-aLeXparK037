...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel panel1 = createHeader("Jeopardy");
	...
	public void actionPerformed(ActionEvent e) {
		...
		askQuestion("what is log base 4 of 1 equal to", "0", 200);
		}
		...
		if(thirdButton==e.getSource()) {
			askQuestion("Which US President was elected on March 4th, 1861 (Respond with the last name and no caps)", "lincoln",800);
		}
		if (fourthButton==e.getSource()) {
			askQuestion("What color sqaure does the White King in chess go on?", "black", 1000);
		}
